...
public class Picture extends SimplePicture 
{
  ...
  // {
    ...
    // {
      // for (Pixel pixelObj : rowArray)
      // {
		// pixelObj.setBlue(pixelObj.getBlue()-140);
  ...
  public void mirrorArms()
  {
    ...
    Pixel botPixelL = null;
	Pixel topPixelR = null;
    Pixel botPixelR = null;
    Pixel[][] pixels = this.getPixels2D();
    ...
    for (int row = 157; row < mirrorPoint; row++)
    {
      for (int col = 104; col < 170; col++)
      {
        ...
        botPixelL = pixels[mirrorPoint-row+mirrorPoint][col];                       
        botPixelL.setColor(topPixelL.getColor());
      }
    }
	...
	for (int row = 171; row < mirrorPoint; row++)
    {
      for (int col = 238; col < 293; col++)
      {
        ...
        botPixelR = pixels[mirrorPoint-row+mirrorPoint][col];                       
        botPixelR.setColor(topPixelR.getColor());
      }
    }
  }
  ...
  public void createCollage()
  {
	...
	this.copy2(flower1,0,50,170,250);
   ...
   public void myCollage()
  {
	...
	Picture robotNeg = new Picture(robot);
	robotNeg.negate();
    this.copy(robotNeg,0,0);
	
    Picture robotNoBlue = new Picture(robot);
    robotNoBlue.zeroBlue();
    this.copy(robotNoBlue,150,0);
	
	Picture robotBlue = new Picture(robot);
    robotBlue.keepOnlyBlue();
    this.copy(robotBlue,300,0);
